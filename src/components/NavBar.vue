    ...
    <div class="container">
      <header class="d-flex justify-content-center py-3">
        <ul class="nav nav-pills">
          ...
          <li v-if="isLoggedIn" class="nav-item"><router-link to="/logout" class="nav-link">Logout</router-link></li>
          ...
          <li v-else class="nav-item"><router-link to="/signup"><button class="btn btn-primary mt-0" style="width: 100%"><i class="fa fa-user userIcon mr-2"></i>Sign Up</button></router-link></li>
        </ul>
      </header>
    </div>
</template>
